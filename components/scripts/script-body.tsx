...
export function ScriptBody({ script }: ScriptBodyProps) {
  return (
    <article className="surface-border fade-in-up rounded-[24px] bg-panel p-5 sm:p-6">
      ...
      <div className="mt-5 rounded-[20px] border border-border bg-background-muted p-4">
        <pre className="overflow-x-auto text-sm leading-7 text-foreground">
          <code>{script.script}</code>
        </pre>
      </div>
      <div className="mt-6 rounded-[20px] border border-border bg-background-muted p-5">
