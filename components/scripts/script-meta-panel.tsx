...
export function ScriptMetaPanel({ script }: ScriptMetaPanelProps) {
  return (
    <aside className="surface-border fade-in-up rounded-[20px] bg-panel p-5">
      ...
      <dl className="mt-5 space-y-3 text-sm">
        ...
        <div className="space-y-2 rounded-[16px] border border-border bg-background-muted p-4">
          <dt className="text-foreground-muted">Description</dt>
          <dd className="leading-6">{script.description}</dd>
        </div>
      </dl>
    </aside>
  );
